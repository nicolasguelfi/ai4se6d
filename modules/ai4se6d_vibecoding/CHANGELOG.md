...
### Added
- VibeCoding session 1: foundations of vibe coding and vibe engineering
- VibeCoding session 2: advanced patterns and practical exercises
- CE review report with multi-perspective feedback
- Production plans (initial + complete)
- `doc_version` display
- Design guideline (maximize-viewport)
- Bibliography and export configs

### Fixed
- Resolved merge conflict markers
- Style refactoring from CE review + integrate cycle
