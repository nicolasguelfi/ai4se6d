...
def build():
    with st_block(s.project.containers.page_fill_top):
        ...
        st_write(bs.body, "Live demo with Claude Code \u2014 full 6-phase cycle:")
        st_space("v", 0.5)
        ...
        with st_list(li_style=bs.body, list_type=lt.ordered) as l:
            ...
            with l.item():
                st_write(bs.body, (bs.keyword, "/ce-simplify-code"), " \u2014 simplify the fresh changes before review")
            with l.item():
                st_write(bs.body, (bs.keyword, "/ce-code-review"), " \u2014 multi-perspective review of the result")
            with l.item():
