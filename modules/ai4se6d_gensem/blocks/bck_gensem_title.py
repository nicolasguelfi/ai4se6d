                    ...
                    with g.cell():
                        st_hover_tooltip(
                            ...
                            entries=[
                                ...
                                ("GSE-One", "GSE-One is one methodology for this discipline \u2014 16 principles, 4 lifecycle stages, 24 commands, 10 agents + 1 Orchestrator. It illustrates the discipline and equips you to adapt to others."),
